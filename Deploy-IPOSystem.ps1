# Deploy-IPOSystem.ps1
param([switch]$LaunchTracking, [switch]$PeriwinkleTheme)

Write-Host " DEPLOYING IPO SYSTEM" -ForegroundColor Magenta

$ipoDir = "client/src/components/ipo"
if (!(Test-Path $ipoDir)) { New-Item -ItemType Directory -Path $ipoDir -Force }

# Create IPO Calendar Component
@"
...
"@ | Out-File -FilePath "$ipoDir/IPOCalendar.jsx" -Encoding UTF8

Write-Host " IPO System Created!" -ForegroundColor Green
Write-Host "Next: .\Deploy-Dashboard.ps1" -ForegroundColor Yellow
