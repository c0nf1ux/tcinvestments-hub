# Fix-App-Syntax.ps1
Write-Host " FIXING APP.JS SYNTAX ERROR" -ForegroundColor Yellow
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '12px' }}>
            ...
            <div style={{ color: '#CCCCFF', fontSize: '0.9rem' }}>MTG  Feb 9, 2025  $120</div>
          </div>
          <div style={{ marginBottom: '16px' }}>
            <div style={{ color: '#FFFFFF', fontWeight: 'bold' }}>Temporal Forces</div>
            <div style={{ color: '#CCCCFF', fontSize: '0.9rem' }}>Pokemon  Mar 22, 2025  $150</div>
          </div>
          <button
...
export default App;
"@ | Out-File -FilePath "client/src/App.js" -Encoding UTF8 -Force

Write-Host " App.js syntax fixed!" -ForegroundColor Green
Write-Host " CardHood should now load properly!" -ForegroundColor Cyan
